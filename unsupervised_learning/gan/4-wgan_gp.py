#!/usr/bin/env python3
"""Defines the WGAN_GP class with weight loading."""
...
class WGAN_GP(keras.Model):
    ...
    def get_interpolated_sample(self, real_sample, fake_sample):
        """Generate an interpolated sample between real and fake."""
        u = tf.random.uniform(self.scal_shape)
        v = tf.ones(self.scal_shape) - u
        return u * real_sample + v * fake_sample

    def gradient_penalty(self, interpolated_sample):
        """Compute the gradient penalty for the interpolated sample."""
    ...
    def train_step(self, useless_argument):
        """Perform one training step for the discriminator and generator."""
